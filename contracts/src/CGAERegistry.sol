 ...
 *
 * @dev Deployed on Filecoin Calibnet (or Mainnet). Agents register with an architecture
...
contract CGAERegistry {
    ...
    constructor() {
        ...
        // Default budget ceilings (in FIL wei: 1 FIL = 1e18)
        budgetCeilings[0] = 0;
    ...
    function register(bytes16 architectureHash, string calldata modelName) external {
        ...
        agents[msg.sender] = AgentRecord({
            ...
            lastAuditTime: 0,
            active: false, // Active after first certification
            totalEarned: 0,
            totalPenalties: 0,
