...
export function sessionKeyRegistryCallHandler(data, options) {
    ...
    switch (functionName) {
        case 'authorizationExpiry': {
            ...
            return encodeAbiParameters(Abis.sessionKeyRegistry.find((abi) => abi.type === 'function' && abi.name === 'authorizationExpiry').outputs, options.sessionKeyRegistry.authorizationExpiry(args));
        }
        default: {
