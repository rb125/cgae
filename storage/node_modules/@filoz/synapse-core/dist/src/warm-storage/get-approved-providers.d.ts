...
export declare namespace getApprovedProviders {
    type OptionsType = {
        offset?: bigint;
        limit?: bigint;
        contractAddress?: Address;
    };
    type ContractOutputType = ContractFunctionReturnType<typeof storageViewAbi, 'pure' | 'view', 'getApprovedProviders'>;
    type OutputType = bigint[];
    type ErrorType = asChain.ErrorType | ReadContractErrorType;
}
export declare function getApprovedProviders(client: Client<Transport, Chain>, options?: getApprovedProviders.OptionsType): Promise<getApprovedProviders.OutputType>;
export declare namespace getApprovedProvidersCall {
    type OptionsType = Simplify<getApprovedProviders.OptionsType & ActionCallChain>;
    type ErrorType = asChain.ErrorType;
    type OutputType = ContractFunctionParameters<typeof storageViewAbi, 'pure' | 'view', 'getApprovedProviders'>;
}
export declare function getApprovedProvidersCall(options: getApprovedProvidersCall.OptionsType): {
    abi: readonly [{
...
//# sourceMappingURL=get-approved-providers.d.ts.map