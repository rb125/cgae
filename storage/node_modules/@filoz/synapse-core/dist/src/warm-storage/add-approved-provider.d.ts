...
export declare namespace addApprovedProvider {
    type OptionsType = {
        providerId: bigint;
...
export declare function addApprovedProvider(client: Client<Transport, Chain, Account>, options: addApprovedProvider.OptionsType): Promise<addApprovedProvider.OutputType>;
export declare namespace addApprovedProviderSync {
    type OptionsType = Simplify<addApprovedProvider.OptionsType & ActionSyncCallback>;
    type OutputType = ActionSyncOutput<typeof extractAddApprovedProviderEvent>;
    type ErrorType = addApprovedProviderCall.ErrorType | SimulateContractErrorType | WriteContractErrorType | WaitForTransactionReceiptErrorType;
}
export declare function addApprovedProviderSync(client: Client<Transport, Chain, Account>, options: addApprovedProviderSync.OptionsType): Promise<addApprovedProviderSync.OutputType>;
export declare namespace addApprovedProviderCall {
    type OptionsType = Simplify<addApprovedProvider.OptionsType & ActionCallChain>;
    type ErrorType = asChain.ErrorType;
    type OutputType = ContractFunctionParameters<typeof storageAbi, 'nonpayable', 'addApprovedProvider'>;
}
export declare function addApprovedProviderCall(options: addApprovedProviderCall.OptionsType): {
    abi: readonly [{
...
export declare function extractAddApprovedProviderEvent(logs: Log[]): Log<bigint, number, false, undefined, true, readonly [{
    readonly type: "constructor";
    readonly inputs: readonly [{
        readonly name: "_pdpVerifierAddress";
        readonly internalType: "address";
...
//# sourceMappingURL=add-approved-provider.d.ts.map