...
import type { Address, Chain, Client, ContractFunctionParameters, ContractFunctionReturnType, ReadContractErrorType, Transport } from 'viem';
import type { fwss as storageAbi } from '../abis/index.ts';
import { asChain } from '../chains.ts';
import type { ActionCallChain } from '../types.ts';
export declare namespace getServicePrice {
    type OptionsType = {
        contractAddress?: Address;
    };
    type ContractOutputType = ContractFunctionReturnType<typeof storageAbi, 'pure' | 'view', 'getServicePrice'>;
    type OutputType = {
...
export declare function getServicePrice(client: Client<Transport, Chain>, options?: getServicePrice.OptionsType): Promise<getServicePrice.OutputType>;
export declare namespace getServicePriceCall {
    type OptionsType = Simplify<getServicePrice.OptionsType & ActionCallChain>;
    type ErrorType = asChain.ErrorType;
    type OutputType = ContractFunctionParameters<typeof storageAbi, 'pure' | 'view', 'getServicePrice'>;
}
export declare function getServicePriceCall(options: getServicePriceCall.OptionsType): {
    abi: readonly [{
...
//# sourceMappingURL=get-service-price.d.ts.map