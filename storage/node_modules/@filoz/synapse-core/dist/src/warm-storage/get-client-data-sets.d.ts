...
export declare namespace getClientDataSets {
    type OptionsType = {
        address: Address;
        contractAddress?: Address;
    };
    type ContractOutputType = ContractFunctionReturnType<typeof storageViewAbi, 'pure' | 'view', 'getClientDataSets'>;
    type OutputType = DataSetInfo[];
    type ErrorType = asChain.ErrorType | ReadContractErrorType;
}
export declare function getClientDataSets(client: Client<Transport, Chain>, options: getClientDataSets.OptionsType): Promise<getClientDataSets.OutputType>;
export declare namespace getClientDataSetsCall {
    type OptionsType = Simplify<getClientDataSets.OptionsType & ActionCallChain>;
    type ErrorType = asChain.ErrorType;
    type OutputType = ContractFunctionParameters<typeof storageViewAbi, 'pure' | 'view', 'getClientDataSets'>;
}
export declare function getClientDataSetsCall(options: getClientDataSetsCall.OptionsType): {
    abi: readonly [{
...
//# sourceMappingURL=get-client-data-sets.d.ts.map