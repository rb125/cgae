...
export declare namespace removeProduct {
    type OptionsType = {
        productType?: number;
        contractAddress?: Address;
    };
    type OutputType = Hash;
    type ErrorType = removeProductCall.ErrorType | SimulateContractErrorType | WriteContractErrorType;
}
export declare function removeProduct(client: Client<Transport, Chain, Account>, options?: removeProduct.OptionsType): Promise<removeProduct.OutputType>;
export declare namespace removeProductSync {
    type OptionsType = Simplify<removeProduct.OptionsType & ActionSyncCallback>;
    type OutputType = ActionSyncOutput<typeof extractRemoveProductEvent>;
    type ErrorType = removeProductCall.ErrorType | SimulateContractErrorType | WriteContractErrorType | WaitForTransactionReceiptErrorType;
}
export declare function removeProductSync(client: Client<Transport, Chain, Account>, options?: removeProductSync.OptionsType): Promise<removeProductSync.OutputType>;
export declare namespace removeProductCall {
    type OptionsType = Simplify<removeProduct.OptionsType & ActionCallChain>;
    type ErrorType = asChain.ErrorType;
    type OutputType = ContractFunctionParameters<typeof serviceProviderRegistryAbi, 'nonpayable', 'removeProduct'>;
}
export declare function removeProductCall(options: removeProductCall.OptionsType): {
    abi: readonly [{
...
export declare function extractRemoveProductEvent(logs: Log[]): Log<bigint, number, false, undefined, true, readonly [{
    readonly type: "constructor";
    readonly inputs: readonly [];
    readonly stateMutability: "nonpayable";
}, {
