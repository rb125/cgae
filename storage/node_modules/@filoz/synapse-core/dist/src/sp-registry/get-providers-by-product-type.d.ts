...
export declare namespace getProvidersByProductType {
    type OptionsType = {
        productType: number;
        onlyActive?: boolean;
        offset?: bigint;
    ...
    type OutputType = ContractOutputType;
    type ErrorType = asChain.ErrorType | ReadContractErrorType;
}
export declare function getProvidersByProductType(client: Client<Transport, Chain>, options: getProvidersByProductType.OptionsType): Promise<getProvidersByProductType.OutputType>;
export declare namespace getProvidersByProductTypeCall {
    type OptionsType = Simplify<getProvidersByProductType.OptionsType & ActionCallChain>;
...
export declare function getProvidersByProductTypeCall(options: getProvidersByProductTypeCall.OptionsType): {
    abi: readonly [{
    ...
    args: [number, boolean, bigint, bigint];
};
//# sourceMappingURL=get-providers-by-product-type.d.ts.map