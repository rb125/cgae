...
export declare namespace getProviderIdByAddress {
    type OptionsType = {
        providerAddress: Address;
        contractAddress?: Address;
    };
    type ContractOutputType = ContractFunctionReturnType<typeof serviceProviderRegistryAbi, 'pure' | 'view', 'getProviderIdByAddress'>;
    type OutputType = bigint;
    type ErrorType = asChain.ErrorType | ReadContractErrorType;
}
export declare function getProviderIdByAddress(client: Client<Transport, Chain>, options: getProviderIdByAddress.OptionsType): Promise<getProviderIdByAddress.OutputType>;
export declare namespace getProviderIdByAddressCall {
    type OptionsType = Simplify<getProviderIdByAddress.OptionsType & ActionCallChain>;
    type ErrorType = asChain.ErrorType;
    type OutputType = ContractFunctionParameters<typeof serviceProviderRegistryAbi, 'pure' | 'view', 'getProviderIdByAddress'>;
}
export declare function getProviderIdByAddressCall(options: getProviderIdByAddressCall.OptionsType): {
    abi: readonly [{
...
//# sourceMappingURL=get-provider-id-by-address.d.ts.map