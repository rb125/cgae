...
export declare namespace getPDPProvider {
    type OptionsType = {
        providerId: bigint;
    ...
    type ErrorType = getProviderWithProduct.ErrorType;
}
export declare function getPDPProvider(client: Client<Transport, Chain>, options: getPDPProvider.OptionsType): Promise<getPDPProvider.OutputType>;
export declare namespace getPDPProviderCall {
    type OptionsType = Simplify<getPDPProvider.OptionsType & ActionCallChain>;
    type ErrorType = getProviderWithProductCall.ErrorType;
    type OutputType = getProviderWithProductCall.OutputType;
}
export declare function getPDPProviderCall(options: getPDPProviderCall.OptionsType): {
    abi: readonly [{
...
export declare function parsePDPProvider(data: getPDPProvider.ContractOutputType): PDPProvider;
//# sourceMappingURL=get-pdp-provider.d.ts.map