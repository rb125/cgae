...
export declare namespace registerProvider {
    type OptionsType = {
        payee: Address;
        name: string;
        description: string;
    ...
    type ErrorType = registerProviderCall.ErrorType | SimulateContractErrorType | WriteContractErrorType;
}
export declare function registerProvider(client: Client<Transport, Chain, Account>, options: registerProvider.OptionsType): Promise<registerProvider.OutputType>;
export declare namespace registerProviderSync {
    type OptionsType = Simplify<registerProvider.OptionsType & ActionSyncCallback>;
    type OutputType = ActionSyncOutput<typeof extractRegisterProviderEvent>;
    type ErrorType = registerProviderCall.ErrorType | SimulateContractErrorType | WriteContractErrorType | WaitForTransactionReceiptErrorType;
}
export declare function registerProviderSync(client: Client<Transport, Chain, Account>, options: registerProviderSync.OptionsType): Promise<registerProviderSync.OutputType>;
export declare namespace registerProviderCall {
    type OptionsType = Simplify<SetRequired<registerProvider.OptionsType, 'value'> & ActionCallChain>;
    type ErrorType = asChain.ErrorType;
    type OutputType = ContractFunctionParameters<typeof serviceProviderRegistryAbi, 'payable', 'registerProvider'> & {
        value: bigint;
    };
}
export declare function registerProviderCall(options: registerProviderCall.OptionsType): {
    abi: readonly [{
    ...
    args: [`0x${string}`, string, string, number, string[], `0x${string}`[]];
    value: bigint;
};
export declare function extractRegisterProviderEvent(logs: Log[]): Log<bigint, number, false, undefined, true, readonly [{
    readonly type: "constructor";
    readonly inputs: readonly [];
    readonly stateMutability: "nonpayable";
}, {
