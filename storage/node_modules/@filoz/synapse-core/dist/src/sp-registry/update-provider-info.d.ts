...
export declare namespace updateProviderInfo {
    type OptionsType = {
        name: string;
        description: string;
    ...
    type ErrorType = updateProviderInfoCall.ErrorType | SimulateContractErrorType | WriteContractErrorType;
}
export declare function updateProviderInfo(client: Client<Transport, Chain, Account>, options: updateProviderInfo.OptionsType): Promise<updateProviderInfo.OutputType>;
export declare namespace updateProviderInfoSync {
    type OptionsType = Simplify<updateProviderInfo.OptionsType & ActionSyncCallback>;
    type OutputType = ActionSyncOutput<typeof extractUpdateProviderInfoEvent>;
    type ErrorType = updateProviderInfoCall.ErrorType | SimulateContractErrorType | WriteContractErrorType | WaitForTransactionReceiptErrorType;
}
export declare function updateProviderInfoSync(client: Client<Transport, Chain, Account>, options: updateProviderInfoSync.OptionsType): Promise<updateProviderInfoSync.OutputType>;
export declare namespace updateProviderInfoCall {
    type OptionsType = Simplify<updateProviderInfo.OptionsType & ActionCallChain>;
    type ErrorType = asChain.ErrorType;
    type OutputType = ContractFunctionParameters<typeof serviceProviderRegistryAbi, 'nonpayable', 'updateProviderInfo'>;
}
export declare function updateProviderInfoCall(options: updateProviderInfoCall.OptionsType): {
    abi: readonly [{
...
export declare function extractUpdateProviderInfoEvent(logs: Log[]): Log<bigint, number, false, undefined, true, readonly [{
    readonly type: "constructor";
    readonly inputs: readonly [];
    readonly stateMutability: "nonpayable";
}, {
...
//# sourceMappingURL=update-provider-info.d.ts.map