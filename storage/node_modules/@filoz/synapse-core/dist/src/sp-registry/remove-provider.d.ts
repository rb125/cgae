...
export declare namespace removeProvider {
    type OptionsType = {
        contractAddress?: Address;
    };
    type OutputType = Hash;
    type ErrorType = removeProviderCall.ErrorType | SimulateContractErrorType | WriteContractErrorType;
}
export declare function removeProvider(client: Client<Transport, Chain, Account>, options?: removeProvider.OptionsType): Promise<removeProvider.OutputType>;
export declare namespace removeProviderSync {
    type OptionsType = Simplify<removeProvider.OptionsType & ActionSyncCallback>;
    type OutputType = ActionSyncOutput<typeof extractRemoveProviderEvent>;
    type ErrorType = removeProviderCall.ErrorType | SimulateContractErrorType | WriteContractErrorType | WaitForTransactionReceiptErrorType;
}
export declare function removeProviderSync(client: Client<Transport, Chain, Account>, options?: removeProviderSync.OptionsType): Promise<removeProviderSync.OutputType>;
export declare namespace removeProviderCall {
    type OptionsType = Simplify<removeProvider.OptionsType & ActionCallChain>;
    type ErrorType = asChain.ErrorType;
    type OutputType = ContractFunctionParameters<typeof serviceProviderRegistryAbi, 'nonpayable', 'removeProvider'>;
}
export declare function removeProviderCall(options: removeProviderCall.OptionsType): {
    abi: readonly [{
...
export declare function extractRemoveProviderEvent(logs: Log[]): Log<bigint, number, false, undefined, true, readonly [{
    readonly type: "constructor";
    readonly inputs: readonly [];
    readonly stateMutability: "nonpayable";
}, {
...
//# sourceMappingURL=remove-provider.d.ts.map