...
export declare namespace isRegisteredProvider {
    type OptionsType = {
        provider: Address;
        contractAddress?: Address;
    };
    type ContractOutputType = ContractFunctionReturnType<typeof serviceProviderRegistryAbi, 'pure' | 'view', 'isRegisteredProvider'>;
    type OutputType = boolean;
    type ErrorType = asChain.ErrorType | ReadContractErrorType;
}
export declare function isRegisteredProvider(client: Client<Transport, Chain>, options: isRegisteredProvider.OptionsType): Promise<isRegisteredProvider.OutputType>;
export declare namespace isRegisteredProviderCall {
    type OptionsType = Simplify<isRegisteredProvider.OptionsType & ActionCallChain>;
    type ErrorType = asChain.ErrorType;
    type OutputType = ContractFunctionParameters<typeof serviceProviderRegistryAbi, 'pure' | 'view', 'isRegisteredProvider'>;
}
export declare function isRegisteredProviderCall(options: isRegisteredProviderCall.OptionsType): {
    abi: readonly [{
...
//# sourceMappingURL=is-registered-provider.d.ts.map