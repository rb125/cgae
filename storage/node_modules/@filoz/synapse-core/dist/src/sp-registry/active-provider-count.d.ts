...
export declare namespace activeProviderCount {
    type OptionsType = {
        contractAddress?: Address;
    };
    type ContractOutputType = ContractFunctionReturnType<typeof serviceProviderRegistryAbi, 'pure' | 'view', 'activeProviderCount'>;
    type OutputType = bigint;
    type ErrorType = asChain.ErrorType | ReadContractErrorType;
}
export declare function activeProviderCount(client: Client<Transport, Chain>, options?: activeProviderCount.OptionsType): Promise<activeProviderCount.OutputType>;
export declare namespace activeProviderCountCall {
    type OptionsType = Simplify<activeProviderCount.OptionsType & ActionCallChain>;
    type ErrorType = asChain.ErrorType;
    type OutputType = ContractFunctionParameters<typeof serviceProviderRegistryAbi, 'pure' | 'view', 'activeProviderCount'>;
}
export declare function activeProviderCountCall(options: activeProviderCountCall.OptionsType): {
    abi: readonly [{
...
//# sourceMappingURL=active-provider-count.d.ts.map