...
export declare namespace getProviderCount {
    type OptionsType = {
        contractAddress?: Address;
    };
    type ContractOutputType = ContractFunctionReturnType<typeof serviceProviderRegistryAbi, 'pure' | 'view', 'getProviderCount'>;
    type OutputType = bigint;
    type ErrorType = asChain.ErrorType | ReadContractErrorType;
}
export declare function getProviderCount(client: Client<Transport, Chain>, options?: getProviderCount.OptionsType): Promise<getProviderCount.OutputType>;
export declare namespace getProviderCountCall {
    type OptionsType = Simplify<getProviderCount.OptionsType & ActionCallChain>;
    type ErrorType = asChain.ErrorType;
    type OutputType = ContractFunctionParameters<typeof serviceProviderRegistryAbi, 'pure' | 'view', 'getProviderCount'>;
}
export declare function getProviderCountCall(options: getProviderCountCall.OptionsType): {
    abi: readonly [{
...
//# sourceMappingURL=get-provider-count.d.ts.map