...
export declare namespace isProviderActive {
    type OptionsType = {
        providerId: bigint;
        contractAddress?: Address;
    };
    type ContractOutputType = ContractFunctionReturnType<typeof serviceProviderRegistryAbi, 'pure' | 'view', 'isProviderActive'>;
    type OutputType = boolean;
    type ErrorType = asChain.ErrorType | ReadContractErrorType;
}
export declare function isProviderActive(client: Client<Transport, Chain>, options: isProviderActive.OptionsType): Promise<isProviderActive.OutputType>;
export declare namespace isProviderActiveCall {
    type OptionsType = Simplify<isProviderActive.OptionsType & ActionCallChain>;
    type ErrorType = asChain.ErrorType;
    type OutputType = ContractFunctionParameters<typeof serviceProviderRegistryAbi, 'pure' | 'view', 'isProviderActive'>;
}
export declare function isProviderActiveCall(options: isProviderActiveCall.OptionsType): {
    abi: readonly [{
...
//# sourceMappingURL=is-provider-active.d.ts.map