...
export declare namespace addProduct {
    type OptionsType = {
        productType?: number;
    ...
    type ErrorType = addProductCall.ErrorType | SimulateContractErrorType | WriteContractErrorType;
}
export declare function addProduct(client: Client<Transport, Chain, Account>, options: addProduct.OptionsType): Promise<addProduct.OutputType>;
export declare namespace addProductSync {
    type OptionsType = Simplify<addProduct.OptionsType & ActionSyncCallback>;
    type OutputType = ActionSyncOutput<typeof extractAddProductEvent>;
    type ErrorType = addProductCall.ErrorType | SimulateContractErrorType | WriteContractErrorType | WaitForTransactionReceiptErrorType;
}
export declare function addProductSync(client: Client<Transport, Chain, Account>, options: addProductSync.OptionsType): Promise<addProductSync.OutputType>;
export declare namespace addProductCall {
    type OptionsType = Simplify<Omit<addProduct.OptionsType, 'pdpOffering' | 'capabilities'> & {
        capabilityKeys: string[];
        capabilityValues: readonly `0x${string}`[];
    } & ActionCallChain>;
    type ErrorType = asChain.ErrorType;
    type OutputType = ContractFunctionParameters<typeof serviceProviderRegistryAbi, 'nonpayable', 'addProduct'>;
}
export declare function addProductCall(options: addProductCall.OptionsType): {
    abi: readonly [{
...
export declare function extractAddProductEvent(logs: Log[]): Log<bigint, number, false, undefined, true, readonly [{
    readonly type: "constructor";
    readonly inputs: readonly [];
    readonly stateMutability: "nonpayable";
}, {
