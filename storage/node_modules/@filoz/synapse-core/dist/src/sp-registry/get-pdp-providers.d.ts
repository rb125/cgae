...
import type { Address, Chain, Client, ContractFunctionParameters, ContractFunctionReturnType, MulticallErrorType, ReadContractErrorType, Transport } from 'viem';
...
export declare namespace getPDPProviders {
    type OptionsType = Omit<getProvidersByProductType.OptionsType, 'productType'>;
    type ContractOutputType = ContractFunctionReturnType<typeof serviceProviderRegistryAbi, 'pure' | 'view', 'getProvidersByProductType'>;
    type OutputType = {
        providers: PDPProvider[];
        hasMore: boolean;
    };
    type ErrorType = asChain.ErrorType | ReadContractErrorType;
}
export declare function getPDPProviders(client: Client<Transport, Chain>, options?: getPDPProviders.OptionsType): Promise<getPDPProviders.OutputType>;
export declare namespace getPDPProvidersCall {
    type OptionsType = Simplify<getPDPProviders.OptionsType & ActionCallChain>;
    type ErrorType = asChain.ErrorType;
    type OutputType = ContractFunctionParameters<typeof serviceProviderRegistryAbi, 'pure' | 'view', 'getProvidersByProductType'>;
}
export declare function getPDPProvidersCall(options: getPDPProvidersCall.OptionsType): {
    abi: readonly [{
        ...
        readonly inputs: readonly [{
            ...
            readonly internalType: "struct ServiceProviderRegistry.PlannedUpgrade";
            readonly type: "tuple";
        ...
        readonly name: "getAllProductCapabilities";
        readonly outputs: readonly [{
        ...
        readonly outputs: readonly [{
            readonly name: "info";
            readonly internalType: "struct ServiceProviderRegistry.ServiceProviderInfoView";
            readonly type: "tuple";
            readonly components: readonly [{
                readonly name: "providerId";
                readonly internalType: "uint256";
        ...
        readonly name: "getProviderPayee";
        readonly outputs: readonly [{
            readonly name: "payee";
            readonly internalType: "address";
            readonly type: "address";
        ...
        readonly name: "getProviderWithProduct";
        readonly outputs: readonly [{
            readonly name: "";
            ...
            readonly components: readonly [{
                ...
                readonly name: "productCapabilityValues";
                readonly internalType: "bytes[]";
                readonly type: "bytes[]";
            }];
        }];
        ...
        readonly name: "getProvidersByIds";
        readonly outputs: readonly [{
            readonly name: "providerInfos";
            readonly internalType: "struct ServiceProviderRegistry.ServiceProviderInfoView[]";
            readonly type: "tuple[]";
            readonly components: readonly [{
                readonly name: "providerId";
    ...
    args: [0, boolean, bigint, bigint];
};
export declare function parsePDPProviders(data: getPDPProviders.ContractOutputType): getPDPProviders.OutputType;
export declare namespace getApprovedPDPProviders {
    type OptionsType = Omit<getPDPProviders.OptionsType, 'onlyActive' | 'offset' | 'limit'>;
    type OutputType = PDPProvider[];
    type ErrorType = asChain.ErrorType | MulticallErrorType | getApprovedProvidersCall.ErrorType | getPDPProvidersCall.ErrorType;
}
export declare function getApprovedPDPProviders(client: Client<Transport, Chain>, options?: getApprovedPDPProviders.OptionsType): Promise<getApprovedPDPProviders.OutputType>;
export declare namespace getPDPProvidersByIds {
    type OptionsType = {
        providerIds: bigint[];
...
export declare function getPDPProvidersByIds(client: Client<Transport, Chain>, options: getPDPProvidersByIds.OptionsType): Promise<getPDPProvidersByIds.OutputType>;
//# sourceMappingURL=get-pdp-providers.d.ts.map