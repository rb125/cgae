...
export declare namespace getProviderWithProduct {
    type OptionsType = {
        providerId: bigint;
        productType: number;
        contractAddress?: Address;
    };
    type ContractOutputType = ContractFunctionReturnType<typeof serviceProviderRegistryAbi, 'pure' | 'view', 'getProviderWithProduct'>;
    type OutputType = ContractOutputType;
    type ErrorType = asChain.ErrorType | ReadContractErrorType;
}
export declare function getProviderWithProduct(client: Client<Transport, Chain>, options: getProviderWithProduct.OptionsType): Promise<getProviderWithProduct.OutputType>;
export declare namespace getProviderWithProductCall {
    type OptionsType = Simplify<getProviderWithProduct.OptionsType & ActionCallChain>;
    type ErrorType = asChain.ErrorType;
    type OutputType = ContractFunctionParameters<typeof serviceProviderRegistryAbi, 'pure' | 'view', 'getProviderWithProduct'>;
}
export declare function getProviderWithProductCall(options: getProviderWithProductCall.OptionsType): {
    abi: readonly [{
...
//# sourceMappingURL=get-provider-with-product.d.ts.map