...
export declare namespace getRailsForPayeeAndToken {
    type OptionsType = {
        payee: Address;
        token?: Address;
        offset?: bigint;
    ...
    type ContractOutputType = ContractFunctionReturnType<typeof paymentsAbi, 'pure' | 'view', 'getRailsForPayeeAndToken'>;
    type OutputType = {
        results: RailInfo[];
        nextOffset: bigint;
        total: bigint;
    };
    type ErrorType = getRailsForPayeeAndTokenCall.ErrorType | ReadContractErrorType;
}
export declare function getRailsForPayeeAndToken(client: Client<Transport, Chain>, options: getRailsForPayeeAndToken.OptionsType): Promise<getRailsForPayeeAndToken.OutputType>;
export declare namespace getRailsForPayeeAndTokenCall {
    type OptionsType = Simplify<getRailsForPayeeAndToken.OptionsType & ActionCallChain>;
    type ErrorType = asChain.ErrorType;
    type OutputType = ContractFunctionParameters<typeof paymentsAbi, 'pure' | 'view', 'getRailsForPayeeAndToken'>;
}
export declare function getRailsForPayeeAndTokenCall(options: getRailsForPayeeAndTokenCall.OptionsType): {
    abi: readonly [{
    ...
    args: [`0x${string}`, `0x${string}`, bigint, bigint];
};
export declare function parseGetRailsForPayeeAndToken(data: getRailsForPayeeAndToken.ContractOutputType): getRailsForPayeeAndToken.OutputType;
//# sourceMappingURL=get-rails-for-payee-and-token.d.ts.map