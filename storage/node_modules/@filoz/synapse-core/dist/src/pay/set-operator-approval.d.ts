...
export declare namespace setOperatorApproval {
    type OptionsType = {
        token?: Address;
        operator?: Address;
        approve: boolean;
    ...
    type ErrorType = setOperatorApprovalCall.ErrorType | SimulateContractErrorType | WriteContractErrorType;
}
export declare function setOperatorApproval(client: Client<Transport, Chain, Account>, options: setOperatorApproval.OptionsType): Promise<Hash>;
export declare namespace setOperatorApprovalSync {
    type OptionsType = Simplify<setOperatorApproval.OptionsType & ActionSyncCallback>;
    type OutputType = ActionSyncOutput<typeof extractSetOperatorApprovalEvent>;
    type ErrorType = setOperatorApprovalCall.ErrorType | SimulateContractErrorType | WriteContractErrorType | WaitForTransactionReceiptErrorType;
}
export declare function setOperatorApprovalSync(client: Client<Transport, Chain, Account>, options: setOperatorApprovalSync.OptionsType): Promise<setOperatorApprovalSync.OutputType>;
export declare namespace setOperatorApprovalCall {
    type OptionsType = Simplify<setOperatorApproval.OptionsType & ActionCallChain>;
    type ErrorType = asChain.ErrorType | ValidationError;
    type OutputType = ContractFunctionParameters<typeof paymentsAbi, 'nonpayable', 'setOperatorApproval'>;
}
export declare function setOperatorApprovalCall(options: setOperatorApprovalCall.OptionsType): setOperatorApprovalCall.OutputType;
export declare function extractSetOperatorApprovalEvent(logs: Log[]): Log<bigint, number, false, undefined, true, readonly [{
...
//# sourceMappingURL=set-operator-approval.d.ts.map