...
export declare namespace getRailsForPayerAndToken {
    type OptionsType = {
        payer: Address;
        token?: Address;
        offset?: bigint;
    ...
    type ContractOutputType = ContractFunctionReturnType<typeof paymentsAbi, 'pure' | 'view', 'getRailsForPayerAndToken'>;
    type OutputType = {
        results: RailInfo[];
        nextOffset: bigint;
        total: bigint;
    };
    type ErrorType = getRailsForPayerAndTokenCall.ErrorType | ReadContractErrorType;
}
export declare function getRailsForPayerAndToken(client: Client<Transport, Chain>, options: getRailsForPayerAndToken.OptionsType): Promise<getRailsForPayerAndToken.OutputType>;
export declare namespace getRailsForPayerAndTokenCall {
    type OptionsType = Simplify<getRailsForPayerAndToken.OptionsType & ActionCallChain>;
    type ErrorType = asChain.ErrorType;
    type OutputType = ContractFunctionParameters<typeof paymentsAbi, 'pure' | 'view', 'getRailsForPayerAndToken'>;
}
export declare function getRailsForPayerAndTokenCall(options: getRailsForPayerAndTokenCall.OptionsType): {
    abi: readonly [{
...
export declare function parseGetRailsForPayerAndToken(data: getRailsForPayerAndToken.ContractOutputType): getRailsForPayerAndToken.OutputType;
//# sourceMappingURL=get-rails-for-payer-and-token.d.ts.map