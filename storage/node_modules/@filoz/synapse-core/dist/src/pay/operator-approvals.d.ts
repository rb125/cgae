...
export declare namespace operatorApprovals {
    type OptionsType = {
        token?: Address;
        address: Address;
        operator?: Address;
    ...
    type ContractOutputType = ContractFunctionReturnType<typeof paymentsAbi, 'pure' | 'view', 'operatorApprovals'>;
    type OutputType = {
        isApproved: boolean;
...
export declare function operatorApprovals(client: Client<Transport, Chain>, options: operatorApprovals.OptionsType): Promise<operatorApprovals.OutputType>;
export declare namespace operatorApprovalsCall {
    type OptionsType = Simplify<operatorApprovals.OptionsType & ActionCallChain>;
    type ErrorType = asChain.ErrorType;
    type OutputType = ContractFunctionParameters<typeof paymentsAbi, 'pure' | 'view', 'operatorApprovals'>;
}
export declare function operatorApprovalsCall(options: operatorApprovalsCall.OptionsType): {
    abi: readonly [{
...
export declare function parseOperatorApprovals(data: operatorApprovals.ContractOutputType): operatorApprovals.OutputType;
//# sourceMappingURL=operator-approvals.d.ts.map