...
export declare namespace deposit {
    ...
    type ErrorType = depositCall.ErrorType | SimulateContractErrorType | WriteContractErrorType;
}
export declare function deposit(client: Client<Transport, Chain, Account>, options: deposit.OptionsType): Promise<Hash>;
export declare namespace depositSync {
    type OptionsType = Simplify<deposit.OptionsType & ActionSyncCallback>;
    type OutputType = ActionSyncOutput<typeof extractDepositEvent>;
    type ErrorType = depositCall.ErrorType | SimulateContractErrorType | WriteContractErrorType | WaitForTransactionReceiptErrorType;
}
export declare function depositSync(client: Client<Transport, Chain, Account>, options: depositSync.OptionsType): Promise<depositSync.OutputType>;
export declare namespace depositCall {
    type OptionsType = Simplify<SetRequired<deposit.OptionsType, 'to'> & ActionCallChain>;
    type ErrorType = asChain.ErrorType | ValidationError;
    type OutputType = ContractFunctionParameters<typeof paymentsAbi, 'payable', 'deposit'>;
}
export declare function depositCall(options: depositCall.OptionsType): depositCall.OutputType;
export declare function extractDepositEvent(logs: Log[]): Log<bigint, number, false, undefined, true, readonly [{
