...
export declare namespace accounts {
    ...
    type ContractOutputType = ContractFunctionReturnType<typeof paymentsAbi, 'pure' | 'view', 'accounts'>;
    type OutputType = {
        funds: bigint;
...
export declare function accounts(client: Client<Transport, Chain>, options: accounts.OptionsType): Promise<accounts.OutputType>;
export declare namespace accountsCall {
    type OptionsType = Simplify<Omit<accounts.OptionsType, 'blockNumber'> & ActionCallChain>;
    type ErrorType = asChain.ErrorType;
    type OutputType = ContractFunctionParameters<typeof paymentsAbi, 'pure' | 'view', 'accounts'>;
}
export declare function accountsCall(options: accountsCall.OptionsType): {
    abi: readonly [{
...
export declare function parseAccounts(data: accounts.ContractOutputType, currentEpoch: bigint): accounts.OutputType;
