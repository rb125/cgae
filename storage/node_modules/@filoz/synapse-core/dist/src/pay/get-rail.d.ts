...
export declare namespace getRail {
    type OptionsType = {
        railId: bigint;
        contractAddress?: Address;
    };
    type ContractOutputType = ContractFunctionReturnType<typeof paymentsAbi, 'pure' | 'view', 'getRail'>;
    type OutputType = {
        token: Address;
        from: Address;
        to: Address;
    ...
    type ErrorType = getRailCall.ErrorType | ReadContractErrorType;
}
export declare function getRail(client: Client<Transport, Chain>, options: getRail.OptionsType): Promise<getRail.OutputType>;
export declare namespace getRailCall {
    type OptionsType = Simplify<getRail.OptionsType & ActionCallChain>;
    type ErrorType = asChain.ErrorType;
    type OutputType = ContractFunctionParameters<typeof paymentsAbi, 'pure' | 'view', 'getRail'>;
}
export declare function getRailCall(options: getRailCall.OptionsType): {
    abi: readonly [{
...
//# sourceMappingURL=get-rail.d.ts.map