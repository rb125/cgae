...
export declare namespace settleRail {
    type OptionsType = {
        railId: bigint;
        untilEpoch?: bigint;
        contractAddress?: Address;
    };
    type ErrorType = settleRailCall.ErrorType | SimulateContractErrorType | WriteContractErrorType;
}
export declare function settleRail(client: Client<Transport, Chain, Account>, options: settleRail.OptionsType): Promise<Hash>;
export declare namespace settleRailSync {
    type OptionsType = Simplify<settleRail.OptionsType & ActionSyncCallback>;
    type OutputType = ActionSyncOutput<typeof extractSettleRailEvent>;
    type ErrorType = settleRailCall.ErrorType | SimulateContractErrorType | WriteContractErrorType | WaitForTransactionReceiptErrorType;
}
export declare function settleRailSync(client: Client<Transport, Chain, Account>, options: settleRailSync.OptionsType): Promise<settleRailSync.OutputType>;
export declare namespace settleRailCall {
    type OptionsType = Simplify<SetRequired<settleRail.OptionsType, 'untilEpoch'> & ActionCallChain>;
    type ErrorType = asChain.ErrorType;
    type OutputType = ContractFunctionParameters<typeof paymentsAbi, 'nonpayable', 'settleRail'>;
}
export declare function settleRailCall(options: settleRailCall.OptionsType): settleRailCall.OutputType;
export declare function extractSettleRailEvent(logs: Log[]): Log<bigint, number, false, undefined, true, readonly [{
...
//# sourceMappingURL=settle-rail.d.ts.map