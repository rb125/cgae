...
export declare namespace getDataSetListener {
    type OptionsType = {
        dataSetId: bigint;
        contractAddress?: Address;
    };
    type OutputType = Address;
    type ErrorType = asChain.ErrorType | ReadContractErrorType;
}
export declare function getDataSetListener(client: Client<Transport, Chain>, options: getDataSetListener.OptionsType): Promise<getDataSetListener.OutputType>;
export declare namespace getDataSetListenerCall {
    type OptionsType = Simplify<getDataSetListener.OptionsType & ActionCallChain>;
    type ErrorType = asChain.ErrorType;
    type OutputType = ContractFunctionParameters<typeof pdpVerifierAbi, 'pure' | 'view', 'getDataSetListener'>;
}
export declare function getDataSetListenerCall(options: getDataSetListenerCall.OptionsType): {
    abi: readonly [{
...
//# sourceMappingURL=get-data-set-listener.d.ts.map