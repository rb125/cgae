...
export declare namespace getDataSetLeafCount {
    type OptionsType = {
        dataSetId: bigint;
...
export declare function getDataSetLeafCount(client: Client<Transport, Chain>, options: getDataSetLeafCount.OptionsType): Promise<getDataSetLeafCount.OutputType>;
export declare namespace getDataSetLeafCountCall {
    type OptionsType = Simplify<getDataSetLeafCount.OptionsType & ActionCallChain>;
    type ErrorType = asChain.ErrorType;
    type OutputType = ContractFunctionParameters<typeof pdpVerifierAbi, 'pure' | 'view', 'getDataSetLeafCount'>;
}
export declare function getDataSetLeafCountCall(options: getDataSetLeafCountCall.OptionsType): {
    abi: readonly [{
...
//# sourceMappingURL=get-data-set-leaf-count.d.ts.map