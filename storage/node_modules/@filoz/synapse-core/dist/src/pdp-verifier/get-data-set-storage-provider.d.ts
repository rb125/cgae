...
export declare namespace getDataSetStorageProvider {
    type OptionsType = {
        dataSetId: bigint;
        contractAddress?: Address;
    };
    type OutputType = readonly [`0x${string}`, `0x${string}`];
    type ContractOutputType = ContractFunctionReturnType<typeof pdpVerifierAbi, 'pure' | 'view', 'getDataSetStorageProvider'>;
    type ErrorType = asChain.ErrorType | ReadContractErrorType;
}
export declare function getDataSetStorageProvider(client: Client<Transport, Chain>, options: getDataSetStorageProvider.OptionsType): Promise<getDataSetStorageProvider.OutputType>;
export declare namespace getDataSetStorageProviderCall {
    type OptionsType = Simplify<getDataSetStorageProvider.OptionsType & ActionCallChain>;
    type ErrorType = asChain.ErrorType;
    type OutputType = ContractFunctionParameters<typeof pdpVerifierAbi, 'pure' | 'view', 'getDataSetStorageProvider'>;
}
export declare function getDataSetStorageProviderCall(options: getDataSetStorageProviderCall.OptionsType): {
    abi: readonly [{
        ...
        readonly type: "function";
        readonly inputs: readonly [{
            readonly name: "proofSize";
            readonly internalType: "uint256";
            readonly type: "uint256";
        }];
        readonly name: "calculateProofFeeForSize";
        readonly outputs: readonly [{
            readonly name: "";
            readonly internalType: "uint256";
            readonly type: "uint256";
        ...
        readonly type: "function";
        readonly inputs: readonly [];
        readonly name: "feeEffectiveTime";
        readonly outputs: readonly [{
            readonly name: "";
        ...
        readonly type: "function";
        readonly inputs: readonly [];
        readonly name: "proposedFeePerTiB";
        readonly outputs: readonly [{
            readonly name: "";
            readonly internalType: "uint96";
            readonly type: "uint96";
        ...
        readonly type: "function";
        readonly inputs: readonly [{
            readonly name: "newFeePerTiB";
            readonly internalType: "uint256";
            readonly type: "uint256";
        }];
        readonly name: "updateProofFee";
        readonly outputs: readonly [];
        readonly stateMutability: "nonpayable";
    }, {
        readonly type: "function";
        ...
        readonly name: "FeeUpdateProposed";
    }, {
        readonly type: "event";
        readonly anonymous: false;
        readonly inputs: readonly [{
...
//# sourceMappingURL=get-data-set-storage-provider.d.ts.map