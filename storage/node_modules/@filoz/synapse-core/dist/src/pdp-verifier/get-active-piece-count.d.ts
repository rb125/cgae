...
export declare namespace getActivePieceCount {
    type OptionsType = {
        dataSetId: bigint;
...
export declare function getActivePieceCount(client: Client<Transport, Chain>, options: getActivePieceCount.OptionsType): Promise<getActivePieceCount.OutputType>;
export declare namespace getActivePieceCountCall {
    type OptionsType = Simplify<getActivePieceCount.OptionsType & ActionCallChain>;
    type ErrorType = asChain.ErrorType;
    type OutputType = ContractFunctionParameters<typeof pdpVerifierAbi, 'pure' | 'view', 'getActivePieceCount'>;
}
export declare function getActivePieceCountCall(options: getActivePieceCountCall.OptionsType): {
    abi: readonly [{
...
//# sourceMappingURL=get-active-piece-count.d.ts.map