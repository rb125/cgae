...
export declare namespace dataSetLive {
    type OptionsType = {
        dataSetId: bigint;
...
export declare function dataSetLive(client: Client<Transport, Chain>, options: dataSetLive.OptionsType): Promise<dataSetLive.OutputType>;
export declare namespace dataSetLiveCall {
    type OptionsType = Simplify<dataSetLive.OptionsType & ActionCallChain>;
    type ErrorType = asChain.ErrorType;
    type OutputType = ContractFunctionParameters<typeof pdpVerifierAbi, 'pure' | 'view', 'dataSetLive'>;
}
export declare function dataSetLiveCall(options: dataSetLiveCall.OptionsType): {
    abi: readonly [{
...
//# sourceMappingURL=data-set-live.d.ts.map