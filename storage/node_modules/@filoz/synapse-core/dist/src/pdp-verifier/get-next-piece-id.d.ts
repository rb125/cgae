...
export declare namespace getNextPieceId {
    type OptionsType = {
        dataSetId: bigint;
...
export declare function getNextPieceId(client: Client<Transport, Chain>, options: getNextPieceId.OptionsType): Promise<getNextPieceId.OutputType>;
export declare namespace getNextPieceIdCall {
    type OptionsType = Simplify<getNextPieceId.OptionsType & ActionCallChain>;
    type ErrorType = asChain.ErrorType;
    type OutputType = ContractFunctionParameters<typeof pdpVerifierAbi, 'pure' | 'view', 'getNextPieceId'>;
}
export declare function getNextPieceIdCall(options: getNextPieceIdCall.OptionsType): {
    abi: readonly [{
...
//# sourceMappingURL=get-next-piece-id.d.ts.map