...
export declare namespace getActivePieces {
    type OptionsType = {
        dataSetId: bigint;
        offset?: bigint;
        limit?: bigint;
    ...
    type ContractOutputType = ContractFunctionReturnType<typeof pdpVerifierAbi, 'pure' | 'view', 'getActivePieces'>;
    type ErrorType = asChain.ErrorType | ReadContractErrorType;
}
export declare function getActivePieces(client: Client<Transport, Chain>, options: getActivePieces.OptionsType): Promise<getActivePieces.OutputType>;
export declare namespace getActivePiecesCall {
    type OptionsType = Simplify<getActivePieces.OptionsType & ActionCallChain>;
    type ErrorType = asChain.ErrorType;
    type OutputType = ContractFunctionParameters<typeof pdpVerifierAbi, 'pure' | 'view', 'getActivePieces'>;
}
export declare function getActivePiecesCall(options: getActivePiecesCall.OptionsType): {
    abi: readonly [{
...
export declare function parseActivePieces(data: getActivePieces.ContractOutputType): getActivePieces.OutputType;
//# sourceMappingURL=get-active-pieces.d.ts.map