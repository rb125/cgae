...
import { TIME_CONSTANTS, TOKENS } from "../utils/index.js";
const server = setup();
...
describe('PaymentsService', () => {
    ...
    describe('walletBalance', () => {
        ...
        it('should throw for invalid token address', async () => {
            try {
                await payments.walletBalance({ token: 'UNKNOWN' });
    ...
    describe('Token operations', () => {
        ...
        it('should throw for unsupported token in allowance', async () => {
            try {
                await payments.allowance({ spender: '0x123', token: 'FIL' });
                assert.fail('Should have thrown');
            }
            catch (error) {
                assert.include(error.message, 'not supported');
        ...
        it('should throw for unsupported token in approve', async () => {
            try {
                await payments.approve({ spender: '0x123', amount: 100n, token: 'FIL' });
                assert.fail('Should have thrown');
            }
            catch (error) {
                assert.include(error.message, 'not supported');
    ...
    describe('Service approvals', () => {
        ...
        it('should approve service as operator', async () => {
            server.use(Mocks.JSONRPC(Mocks.presets.basic));
            const rateAllowance = parseUnits('10');
            const lockupAllowance = parseUnits('1000');
        ...
        it('should throw for unsupported token in service operations', async () => {
            ...
            try {
                await payments.revokeService({ service: serviceAddress, token: 'FIL' });
                assert.fail('Should have thrown');
            }
            catch (error) {
                assert.include(error.message, 'not supported');
            ...
            try {
                await payments.serviceApproval({ service: serviceAddress, token: 'FIL' });
                assert.fail('Should have thrown');
            }
            catch (error) {
                assert.include(error.message, 'not supported');
    ...
    describe('Deposit and Withdraw', () => {
        ...
        it('should throw for unsupported token in deposit', async () => {
            try {
                await payments.deposit({ amount: parseUnits('100'), token: 'FIL' });
                assert.fail('Should have thrown');
            }
            catch (error) {
        ...
        it('should throw for unsupported token in withdraw', async () => {
            try {
                await payments.withdraw({ amount: parseUnits('50'), token: 'FIL' });
                assert.fail('Should have thrown');
            }
            catch (error) {
                assert.include(error.message, 'Unsupported token');
    ...
    describe('Rail Settlement Features', () => {
        describe('getRailsAsPayer', () => {
            ...
            it('should throw for unsupported token', async () => {
                try {
                    await payments.getRailsAsPayer({ token: 'FIL' });
                    assert.fail('Should have thrown');
                }
                catch (error) {
                    assert.include(error.message, 'not supported');
        ...
        describe('getRailsAsPayee', () => {
            ...
            it('should throw for unsupported token', async () => {
                try {
                    await payments.getRailsAsPayee({ token: 'FIL' });
                    assert.fail('Should have thrown');
                }
                catch (error) {
                    assert.include(error.message, 'not supported');
