...
import { FilBeamRetriever } from "../retriever/filbeam.js";
    ...
    describe('CDN handling', () => {
        it('should respond and not pass through', async () => {
            ...
            global.fetch = async (url) => {
                cdnCalled = true;
                assert.strictEqual(url, `https://0xClient.calibration.filbeam.io/${mockPieceCID.toString()}`, 'CDN URL should be constructed correctly');
                return cdnResponse;
            };
            try {
                const cdnRetriever = new FilBeamRetriever({ baseRetriever: mockBaseRetriever, chain: calibration });
...
//# sourceMappingURL=retriever-filcdn.test.js.map