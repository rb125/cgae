...
export interface IKV {
    ...
    clear: () => Promise<void>;
    list: <T = unknown>(selector: KvListSelector, options?: KvListOptions) => KvListIterator<KvEntry<T>>;
