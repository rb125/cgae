...
# Budget ceilings per tier (in tokens/FIL). B_1 < B_2 < ... < B_5
DEFAULT_BUDGET_CEILINGS = {
    Tier.T0: 0.0,
    Tier.T1: 0.01,    # 0.01 FIL - microtasks
    Tier.T2: 0.1,     # 0.1 FIL - verified contracts
    Tier.T3: 1.0,     # 1 FIL - autonomous contracting
    Tier.T4: 10.0,    # 10 FIL - delegation
    Tier.T5: 100.0,   # 100 FIL - self-modification
}
