...
class AccountingLayer:
    ...
    MINIMUM_RESERVE: float = 0.05    # FIL hard floor
    AUDIT_RESERVE: float = 0.02      # ~4 dims × 0.005 FIL
    ...
    def __init__(self, initial_balance: float):
        ...
        self._burn_samples: list = []   # Recent FIL-per-round costs
...
class ExecutionLayer:
    ...
    def execute(self, task: Any, token_cost_fn) -> ExecutionResult:
        ...
        compute FIL cost; the caller owns cost accounting.
        """
